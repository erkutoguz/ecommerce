...
class ProductClientTest {
    ...
    void bulkLookupPostsWrappedRequestAsJson() {
        ...
        productClient.getProductsByIds(new ProductClientLookupRequest(
    ...
    void successfulResponseIsDeserializedAndIgnoresExtraProductFields() {
        ...
        List<OrderProductResponse> response = productClient.getProductsByIds(
                new ProductClientLookupRequest(List.of(FIRST_PRODUCT_ID)));

        assertEquals(List.of(new OrderProductResponse(
                FIRST_PRODUCT_ID,
                "Mechanical Keyboard",
